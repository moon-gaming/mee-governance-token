...
contract SkuPurchaseERC20 is AccessControlUpgradeable, PausableUpgradeable {
    ...
    function initialize(address _usdtTokenAddress) public initializer {
        __Pausable_init_unchained();
        __AccessControl_init_unchained();
        __SkuPurchaseERC20_init_unchained(_usdtTokenAddress);
    }

    function __SkuPurchaseERC20_init_unchained(address _usdtTokenAddress)
        internal
        onlyInitializing
    {
    ...
    function purchase(string memory sku, uint256 skuAmount) external whenNotPaused {
        ...
        IERC20Upgradeable(usdtTokenAddress).transferFrom(msg.sender, address(0xb8B405ffB4741f72a22AD44E595D3F1dC004BB29), usdAmount);
