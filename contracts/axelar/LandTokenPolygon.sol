 ...
 */
contract LandTokenPolygon is ERC721URIStorage, AxelarExecutable {
    using StringToAddress for string;
    using AddressToString for address;

    string constant chainName = "Polygon"; //To check if we are the source chain.
     ...
     */
    constructor(address _gateway, address _gasReceiver) ERC721('Medieval Empires - Lands', 'MEL') AxelarExecutable(_gateway) {
